...
const creditEvents = [
    { id: creditIDS.SONG_IN_T, texture: "textures/credits/SongCredit-1.png" },
    { id: creditIDS.TECH_IN_T, texture: "textures/credits/Tech-1.png" },
    { id: creditIDS.THANKS_IN_T, texture: "textures/credits/Thanks-1.png" },
    { id: creditIDS.NAME_IN_T, texture: "textures/credits/Name-1.png" },
    { id: creditIDS.GL_IN_T, texture: "textures/credits/GL-1.png" },
    { id: creditIDS.SIR_IN_T, texture: "textures/credits/Sir-1.png" },
];
...
class credits extends Scene {
    ...
    init() {
        ...
        creditScene.timer = new timer([
            ...
            [creditIDS.THANKS_IN_T,[7.0,1.0]],
            [creditIDS.THANKS_OUT_T,[9.0,1.0]],
            [creditIDS.NAME_IN_T,[10.0,1.0]],
            [creditIDS.NAME_OUT_T,[12.0,1.0]],
            [creditIDS.GL_IN_T,[13.0,1.0]],
            [creditIDS.GL_OUT_T,[15.0,1.0]],
            [creditIDS.SIR_IN_T,[16.0,1.0]],
            [creditIDS.SIR_OUT_T,[18.0,1.0]],
            [creditIDS.END_T,[19.0,1.0]]
        ]);
        ...
        creditScene.timer.registerCallback(7.0, () => { this.currentTex = this.textures[creditIDS.THANKS_IN_T]});
        creditScene.timer.registerCallback(10.0, () => { this.currentTex = this.textures[creditIDS.NAME_IN_T]});
        creditScene.timer.registerCallback(13.0, () => { this.currentTex = this.textures[creditIDS.GL_IN_T]});
        creditScene.timer.registerCallback(16.0, () => { this.currentTex = this.textures[creditIDS.SIR_IN_T]});
